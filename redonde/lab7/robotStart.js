...
function fillScene() {
    ...
    robot = new Robot(0, 0, 0, 0xFFFE00)
}
...
class Robot {
    ...
    moveRobot() {
        ...
        this.robotLeftShoulder.rotateX(-Math.cos(this.counter) * range);
        this.robotLeftElbow.rotateX(-Math.sin(this.counter) * range * 0.5);

        this.robotRightShoulder.rotateX(Math.cos(this.counter) * range);
        this.robotRightElbow.rotateX(-Math.sin(this.counter) * range * 0.5);

        this.robotHip.rotateY(-Math.cos(this.counter) * range * 0.2);

        this.robotLeftHip.rotateX(-Math.cos(this.counter) * range);
        this.robotLeftKnee.rotateX(Math.sin(this.counter) * range * 0.5);

        this.robotRightHip.rotateX(Math.cos(this.counter) * range);
        this.robotRightKnee.rotateX(Math.sin(this.counter) * range * 0.5);
    }
...
function render() {
    ...
    if (keyboard.pressed("W")) {
        robot.moveRobot();
        robot.root.translateZ(7);
    }

    if (keyboard.pressed("A")) {
        robot.root.rotateY(0.1);
    }



    if (keyboard.pressed("D")) {
        robot.root.rotateY(-.1);
    }
