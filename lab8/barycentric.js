...
function recalculateBarycentricCoords() {
  ...
  // YOUR CODE HERE:
  var e1 = new THREE.Vector3().subVectors(v3.position, v2.position);
  var e2 = new THREE.Vector3().subVectors(v1.position, v3.position);
  var e3 = new THREE.Vector3().subVectors(v2.position, v1.position);
  var d1 = new THREE.Vector3().subVectors(p.position, v1.position);
  var d2 = new THREE.Vector3().subVectors(p.position, v2.position);
  var d3 = new THREE.Vector3().subVectors(p.position, v3.position);
